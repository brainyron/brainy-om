"use client";
import svgPaths from "./svg-bdulbop1u0";
const imgAvatar = "/assets/2048d278b42a915edecb907b44b6c3fbb1f25fd2.png";
const imgAccount = "/assets/6574d1da866521329d4d10cf78086440c444ee0f.png";
import { imgGroup } from "./svg-9gvoh";
  ...
  return (
    <div className="h-[35.355px] relative shrink-0 w-[47.054px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 36">
        <g id="Group">
          <path d={svgPaths.p14c22a80} data-figma-bg-blur-radius="25.4718" fill="var(--fill-0, #0C0D10)" fillOpacity="0.4" id="Path 50" />
          <path d={svgPaths.p3f993780} data-figma-bg-blur-radius="25.4718" fill="var(--fill-0, #0C0D10)" fillOpacity="0.2" id="Path 47" />
          <path d={svgPaths.p1a5c52c0} data-figma-bg-blur-radius="25.4718" fill="var(--fill-0, #0C0D10)" fillOpacity="0.6" id="Path 48" />
          <path d={svgPaths.p29cb1780} data-figma-bg-blur-radius="25.4718" fill="var(--fill-0, #0C0D10)" fillOpacity="0.8" id="Path 49" />
          <path d={svgPaths.p2bfe0c00} data-figma-bg-blur-radius="25.4718" fill="var(--fill-0, #0C0D10)" id="Path 46" />
        </g>
        <defs>
          <clipPath id="bgblur_0_4_2986_clip_path" transform="translate(18.4586 19.8078)">
            <path d={svgPaths.p14c22a80} />
          </clipPath>
          <clipPath id="bgblur_1_4_2986_clip_path" transform="translate(25.4718 6.35177)">
            <path d={svgPaths.p3f993780} />
          </clipPath>
          <clipPath id="bgblur_2_4_2986_clip_path" transform="translate(9.82927 25.4718)">
            <path d={svgPaths.p1a5c52c0} />
          </clipPath>
          <clipPath id="bgblur_3_4_2986_clip_path" transform="translate(5.52251 19.8165)">
            <path d={svgPaths.p29cb1780} />
          </clipPath>
          <clipPath id="bgblur_4_4_2986_clip_path" transform="translate(5.48116 6.33063)">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Sidebar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Sidebar">
          <path d={svgPaths.p18f3be00} id="Icon" stroke="var(--stroke-0, #515254)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start pb-[20px] pt-[10px] px-0 relative shrink-0 w-full" data-name="Logo">
      ...
      <div className="h-0 relative shrink-0 w-full" data-name="Line">
        <div className="absolute inset-[-0.8px_0_0_0]" style={{ "--stroke-0": "rgba(246, 247, 249, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 217 1">
            <path d={svgPaths.p1fac6200} fill="var(--stroke-0, #F6F7F9)" id="Line" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Table">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Table">
          <path d={svgPaths.p3cc96c00} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Item() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[#afb0b1] relative rounded-[20px] shrink-0 w-full" data-name="Item">
      <div aria-hidden="true" className="absolute border-[#969798] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[6px] relative w-full">
          <Table />
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap" dir="auto">
            Dashboard
          </p>
        </div>
      </div>
...
function User() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="User">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="User">
          <path d={svgPaths.p39e64980} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Card() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Card">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Card">
          <path d={svgPaths.p236a1900} id="Vector" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Loan() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Loan">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Loan">
          <path d={svgPaths.p2f371c00} id="Vector" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[6px] relative w-full">
          <Loan />
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap" dir="auto">{`Loans & Facilities`}</p>
        </div>
      </div>
    </div>
  );
...
function TrendingUp() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Trending up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Trending up">
          <path d={svgPaths.p32b1280} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function BarChart() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bar chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bar chart">
          <path d={svgPaths.p3cdd4e00} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[6px] relative w-full">
          <BarChart />
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap" dir="auto">{`Statements & Reports`}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Grid">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Grid">
          <g id="Icon">
            <path d={svgPaths.p1207200} stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p259afa80} stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p1a05d900} stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p4ffcd00} stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[6px] relative w-full">
          <Grid />
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap" dir="auto">{`Services & Tools`}</p>
        </div>
      </div>
    </div>
  );
...
function Transaction() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Transaction">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Transaction">
          <path d={svgPaths.p375ca30} id="Vector" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function CreditCard() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Credit card">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Credit card">
          <path d={svgPaths.p7d55200} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[6px] relative w-full">
          <CreditCard />
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap" dir="auto">{`Payroll & Salaries`}</p>
        </div>
      </div>
    </div>
  );
...
function Bill() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bill">
          <path d={svgPaths.p3ffe9800} fill="var(--stroke-0, #0C0D10)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function HelpCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Help circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_4_2945)" id="Help circle">
          <path d={svgPaths.p2a852000} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
        <defs>
...
function MessageSquare() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Message square">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Message square">
          <path d={svgPaths.p383b2000} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Name() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start justify-center not-italic relative shrink-0 text-nowrap" data-name="Name">
      <p className="font-['outfit:Medium',sans-serif] leading-[22px] relative shrink-0 text-[#0c0d10] text-[16px]" dir="auto">
        Ahmet Yavari
      </p>
      <p className="font-['outfit:Regular',sans-serif] leading-[18px] relative shrink-0 text-[#515254] text-[14px]" dir="auto">
        Manager
      </p>
    </div>
  );
...
function ChevronRight() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Chevron right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Chevron right">
          <path d="M7.5 15L12.5 10L7.5 5" id="Icon" stroke="var(--stroke-0, #747476)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Breadcrumb">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[2px] items-center px-[8px] py-0 relative w-full">
          <p className="font-['outfit:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#747476] text-[18px] text-nowrap" dir="auto">
            Home
          </p>
          <Icon />
          <p className="font-['outfit:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0c0d10] text-[18px] text-nowrap" dir="auto">
            Dashboard
          </p>
        </div>
      </div>
...
function Search() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Search">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Search">
          <path d={svgPaths.p272bfa00} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Icone() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(231,231,232,0.7)] content-stretch flex items-center justify-center relative rounded-[12px] shrink-0 size-[38px]" data-name="Icone">
      <div aria-hidden="true" className="absolute border-[#f6f7f9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Search />
    </div>
  );
}
...
function Bell() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bell">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bell">
          <path d={svgPaths.p27e72a00} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Action">
      ...
      <div className="absolute left-[69px] size-[9px] top-[9px]" data-name="Notif">
        <div className="absolute inset-[-16.67%]" style={{ "--fill-0": "rgba(237, 81, 0, 1)", "--stroke-0": "rgba(231, 231, 232, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
            <circle cx="6" cy="6" fill="var(--fill-0, #ED5100)" id="Notif" r="5.25" stroke="var(--stroke-0, #E7E7E8)" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function TopBar() {
  return (
    <div className="bg-[#f6f7f9] relative rounded-[20px] shrink-0 w-full" data-name="TopBar">
      ...
      <div aria-hidden="true" className="absolute border border-[#f6f7f9] border-solid inset-0 pointer-events-none rounded-[20px]" />
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.7)] content-stretch flex items-center justify-center relative rounded-[18px] shrink-0 size-[60px]" data-name="Icon">
      <div aria-hidden="true" className="absolute border-[#f6f7f9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[18px]" />
      <Icon1 />
    </div>
  );
}
...
function Item12() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[rgba(175,176,177,0.3)] grow min-h-px min-w-px relative rounded-[28px] shrink-0" data-name="Item">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[10px] relative w-full">
          <Icon2 />
          <div className="basis-0 flex flex-col font-['outfit:Regular',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#0c0d10] text-[16px]">
      ...
      <div aria-hidden="true" className="absolute border-[#f6f7f9] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[28px]" />
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      <div className="[grid-area:1_/_1] bg-[#9fbae2] h-[21.325px] ml-[14.1px] mt-0 rounded-[2.096px] w-[15.904px]" data-name="Rectangle" />
      <div className="[grid-area:1_/_1] bg-[#5f8cce] h-[21.325px] ml-[6.87px] mt-[3.98px] rounded-[2.096px] w-[15.904px]" data-name="Rectangle" />
      <div className="[grid-area:1_/_1] bg-[#5081ca] h-[21.325px] ml-0 mt-[8.31px] rounded-[2.096px] w-[15.904px]" data-name="Rectangle" />
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      ...
      <div className="[grid-area:1_/_1] bg-[#ffac0c] h-[9.146px] mix-blend-multiply ml-0 mt-[20.12px] rounded-[20px] w-[30px]" data-name="Rectangle" />
    </div>
  );
}
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[29.493px]">
        <div className="absolute inset-0" style={{ "--fill-0": "rgba(207, 220, 240, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
            <circle cx="14.7464" cy="14.7464" fill="var(--fill-0, #CFDCF0)" id="Ellipse 52" r="14.7464" />
          </svg>
        </div>
      </div>
      ...
      <div className="[grid-area:1_/_1] flex h-[28.189px] items-center justify-center ml-[7.57px] mt-[7.97px] relative w-[27.428px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[52.388deg]">
          <div className="h-[17.735px] relative w-[21.92px]">
            <div className="absolute inset-[3.35%_2.1%_3.16%_6.1%]" style={{ "--fill-0": "rgba(80, 129, 202, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 17">
                <g id="Vector 4" style={{ mixBlendMode: "plus-darker" }}>
                  <path d={svgPaths.p3d5a1100} fill="var(--fill-0, #5081CA)" />
                </g>
              </svg>
            </div>
          </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      ...
      <div className="[grid-area:1_/_1] mix-blend-multiply ml-[21.09px] mt-0 relative size-[10.105px]">
        <div className="absolute inset-[2.66%_2.66%_0_0]" style={{ "--fill-0": "rgba(13, 104, 38, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
            <g id="Vector 10" style={{ mixBlendMode: "multiply" }}>
              <path d={svgPaths.p1dea1ff1} fill="var(--fill-0, #0D6826)" />
            </g>
          </svg>
        </div>
      </div>
      <div className="[grid-area:1_/_1] h-[27.79px] ml-0 mt-[6.89px] relative w-[22.105px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 28">
          <g id="Vector 7" style={{ mixBlendMode: "plus-darker" }}>
            <path d={svgPaths.p3b56f880} fill="url(#paint0_linear_4_2884)" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2884" x1="16.7369" x2="0.631337" y1="4.7369" y2="26.5265">
              <stop stopColor="#A2D28A" />
              <stop offset="1" stopColor="#39834D" />
            </linearGradient>
          </defs>
...
function Bg() {
  return (
    <div className="absolute h-[270px] left-[-5px] top-[-1px] w-[370px]" data-name="BG">
      <div className="absolute inset-[-41.78%_-30.49%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 596 496">
          <g clipPath="url(#clip0_4_2923)" filter="url(#filter0_f_4_2923)" id="BG">
            <path d={svgPaths.p2d0057f0} fill="var(--fill-0, #9DFFD5)" id="Blob" />
            <path d={svgPaths.p3be0bc00} fill="var(--fill-0, #C1FFBA)" id="Blob_2" />
            <path d={svgPaths.p3dd3e800} fill="var(--fill-0, #9DFFD5)" id="Blob_3" />
            <path d={svgPaths.p38c67a80} fill="var(--fill-0, #9DFFD5)" id="Blob_4" />
            <path d={svgPaths.p22c781b0} fill="var(--fill-0, #C1FFBA)" id="Blob_5" />
            <path d={svgPaths.p3ff06f00} fill="var(--fill-0, #9DFFEB)" id="Blob_6" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="495.6" id="filter0_f_4_2923" width="595.6" x="0" y="0">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_4_2923" stdDeviation="56.4" />
            </filter>
            <clipPath id="clip0_4_2923">
              <rect fill="white" height="270" transform="translate(112.8 112.8)" width="370" />
            </clipPath>
          </defs>
        </svg>
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Chevron down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Chevron down">
          <path d="M4 6L8 10L12 6" id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function AccountName() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Account Name">
      <p className="font-['outfit:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0c0d10] text-[18px] text-nowrap">Operating Account</p>
      <ChevronDown />
    </div>
  );
}
...
function Button() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[26px] relative rounded-[16px] shrink-0" data-name="Button">
      <div className="content-stretch flex gap-[8px] h-full items-center justify-center overflow-clip p-[8px] relative rounded-[inherit]">
        <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[14px] text-nowrap">
          <p className="leading-[18px]">Info</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d0d0d1] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
}
...
function Plus() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Plus">
          <path d={svgPaths.p3b397100} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Balance() {
  return (
    <div className="bg-[rgba(175,176,177,0.3)] h-[122px] relative rounded-[20px] shrink-0 w-full" data-name="Balance">
      <div aria-hidden="true" className="absolute border-[#969798] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-start p-[16px] relative size-full text-nowrap">
          <p className="font-['Outfit:Regular',sans-serif] font-normal leading-[40px] relative shrink-0 text-[#0c0d10] text-[36px] tracking-[-0.72px]">28,432.00</p>
          <p className="font-['outfit:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#515254] text-[16px]">British Pound</p>
        </div>
      </div>
    </div>
  );
...
function ArrowUpRight() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Arrow up-right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Arrow up-right">
          <path d={svgPaths.p2657d680} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[26px] relative rounded-[10px] shrink-0" data-name="Button">
      ...
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Arrow down-right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Arrow down-right">
          <path d={svgPaths.p70e9a00} id="Icon" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[28px] shrink-0" data-name="Account">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[28px]">
        <img alt="" className="absolute h-[206.22%] left-[-0.01%] max-w-none top-[-42.72%] w-full" src={imgAccount} />
      </div>
...
function AccountName1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Account Name">
      <p className="font-['outfit:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0c0d10] text-[18px] text-nowrap">My Card</p>
      <ChevronDown1 />
    </div>
  );
}
...
function Header2() {
  return (
    <div className="content-stretch flex items-center relative w-full" data-name="Header">
      <div className="flex flex-col font-['outfit:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap">
        <p className="leading-[22px]" dir="auto">
          Cairo Amman Bank
        </p>
      </div>
...
function Number() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Number">
      <div className="flex flex-col font-['Space_Grotesk:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0c0d10] text-[24px] text-nowrap">
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[32px]" data-name="Card Type">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 20">
        <g id="Card Type">
          <circle cx="22" cy="10" fill="url(#paint0_linear_4_2865)" fillOpacity="0.6" id="Ellipse" r="10" />
          <circle cx="10" cy="10" fill="url(#paint1_linear_4_2865)" fillOpacity="0.6" id="Ellipse_2" r="10" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2865" x1="22" x2="22" y1="0" y2="20">
            <stop stopColor="#2E2F2F" />
            <stop offset="1" stopColor="#2E2F2F" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_4_2865" x1="10" x2="10" y1="0" y2="20">
            <stop stopColor="#2E2F2F" />
            <stop offset="1" stopColor="#2E2F2F" />
          </linearGradient>
        </defs>
...
function Details() {
  return (
    <div className="content-stretch flex items-center justify-between relative w-full" data-name="Details">
      <div className="basis-0 flex flex-col font-['outfit:Regular',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#0c0d10] text-[18px]">
        <p className="leading-[20px]" dir="auto">
          Credit Card
        </p>
      </div>
  ...
  return (
    <div className="relative size-full" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 235 176">
        <g id="Group" opacity="0.7" style={{ mixBlendMode: "plus-darker" }}>
...
function BankCard() {
  return (
    <div className="bg-[rgba(175,176,177,0.3)] h-[209px] relative rounded-[20px] shrink-0 w-full" data-name="Bank card">
      <div className="overflow-clip rounded-[inherit] size-full">
...
function Title() {
  return (
    <div className="content-stretch flex font-['outfit:Regular',sans-serif] items-center justify-between leading-[0] not-italic relative shrink-0 text-nowrap w-full" data-name="Title">
      <div className="flex flex-col justify-center relative shrink-0 text-[#0c0d10] text-[18px]">
        <p className="leading-[20px] text-nowrap">Pending Approvals</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#515254] text-[14px]">
...
function Button7() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[rgba(243,144,92,0.6)] grow min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative w-full">
          <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap">
...
function Button8() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[rgba(246,247,249,0.5)] grow min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative w-full">
          <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[16px] text-nowrap">
...
function DollarSign() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Dollar sign">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Dollar sign">
          <path d={svgPaths.p283eba00} id="Icon" stroke="var(--stroke-0, #515254)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Amount() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Amount">
      <DollarSign />
      <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap">
...
function ChevronDown2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Chevron down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Chevron down">
          <path d="M5 7.5L10 12.5L15 7.5" id="Icon" stroke="var(--stroke-0, #515254)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Amount1() {
  return (
    <div className="bg-[#e7e7e8] relative rounded-[10px] self-stretch shrink-0 w-[122px]" data-name="Amount">
      <div className="content-stretch flex gap-[12px] items-center overflow-clip px-[10px] py-[8px] relative rounded-[inherit] size-full">
        <Amount />
        <ChevronDown2 />
      </div>
      <div aria-hidden="true" className="absolute border-[#969798] border-[0.7px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
}
...
function Calendar() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Calendar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Calendar">
          <path d={svgPaths.p3a9103f0} id="Icon" stroke="var(--stroke-0, #515254)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Date1() {
  return (
    <div className="bg-[#e7e7e8] relative rounded-[10px] self-stretch shrink-0 w-[103px]" data-name="Date">
      <div className="content-stretch flex gap-[12px] items-center overflow-clip px-[10px] py-[8px] relative rounded-[inherit] size-full">
        <Date />
        <ChevronDown3 />
      </div>
    ...
    <div className="h-[286.959px] relative w-[303px]" data-name="BG Approval">
      <div className="absolute inset-[-17.52%_-16.59%_-17.52%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 354 388">
          <g clipPath="url(#clip0_4_2886)" filter="url(#filter0_fn_4_2886)" id="BG Approval">
            <path d={svgPaths.p240abe00} fill="var(--fill-0, #FF5F00)" fillOpacity="0.1" id="Blob" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="387.484" id="filter0_fn_4_2886" width="403.525" x="-50.2624" y="0">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_4_2886" stdDeviation="25.1312" />
              ...
              <feComposite in="coloredNoise1" in2="effect1_foregroundBlur_4_2886" operator="in" result="noise1Clipped" />
              <feFlood floodColor="rgba(0, 0, 0, 0.25)" result="color1Flood" />
              <feComposite in="color1Flood" in2="noise1Clipped" operator="in" result="color1" />
              <feMerge result="effect2_noise_4_2886">
                <feMergeNode in="effect1_foregroundBlur_4_2886" />
...
function Title1() {
  return (
    <div className="content-stretch flex font-['outfit:Regular',sans-serif] items-center justify-between not-italic relative shrink-0 text-[#0c0d10] text-nowrap w-full" data-name="Title">
...
function Text() {
  return (
    <div className="content-stretch flex font-['outfit:Regular',sans-serif] items-center justify-between leading-[0] not-italic relative shrink-0 text-[#0d6826] text-[14px] text-nowrap w-full" data-name="Text">
...
function Text1() {
  return (
    <div className="content-stretch flex font-['outfit:Regular',sans-serif] items-center justify-between leading-[0] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap w-full" data-name="Text">
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[18px] text-nowrap" dir="auto">
          Roll
        </p>
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 140 140">
        <g id="Ellipse">
          <g id="Subtract">
            ...
            <path d={svgPaths.pbfb48f0} fill="var(--fill-0, #D0D0D1)" />
            <path d={svgPaths.p2a396080} fill="var(--fill-0, #D0D0D1)" />
          </g>
        </g>
      </svg>
    </div>
...
function Steps() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="Steps">
      <Ellipse />
      <div className="absolute flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] left-[calc(50%-10.5px)] not-italic text-[#0c0d10] text-[16px] text-nowrap top-[calc(50%+0.5px)] translate-y-[-50%]">
        <p className="leading-[22px]" dir="auto">
          1/3
        </p>
      </div>
...
function Button10() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[#7da867] grow h-[24px] min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Button">
      ...
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Button11() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[rgba(246,247,249,0.5)] grow h-[24px] min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[6px] py-0 relative size-full">
          <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[12px] text-nowrap tracking-[0.24px]">
...
function Approval() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 grow h-[319px] min-h-px min-w-px relative rounded-[12px] shrink-0" data-name="Approval">
      ...
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
  );
}
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 140 140">
        <g id="Ellipse">
          <g id="Subtract">
            ...
            <path d={svgPaths.pa920200} fill="var(--fill-0, #D0D0D1)" />
          </g>
        </g>
      </svg>
    </div>
...
function Ellipse2() {
  return (
    <div className="relative shrink-0 size-[140px]" data-name="Ellipse">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 140 140">
        <g id="Ellipse">
          <path d={svgPaths.pe6aab00} fill="var(--fill-0, #D0D0D1)" id="Ellipse (Stroke)" />
        </g>
      </svg>
    </div>
  );
...
function Approvals() {
  return (
    <div className="basis-0 bg-[#f6f7f9] grow min-h-px min-w-px relative rounded-[28px] shrink-0 w-full" data-name="Approvals">
      <div aria-hidden="true" className="absolute border border-[#d0d0d1] border-solid inset-0 pointer-events-none rounded-[28px]" />
      <div className="size-full">
        <div className="content-stretch flex flex-col items-start justify-between p-[16px] relative size-full">
          <Header3 />
          <Filters />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Apple">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Apple">
          <g id="Vector">
            <path d={svgPaths.p104b5f80} fill="var(--fill-0, #0C0D10)" />
            <path d={svgPaths.p194f4900} fill="var(--fill-0, #0C0D10)" />
          </g>
        </g>
      </svg>
    </div>
...
function Icon11() {
  return (
    <div className="bg-[#f6f7f9] content-stretch flex items-center justify-center relative rounded-[16px] shrink-0 size-[32px]" data-name="Icon">
      <Apple />
    </div>
  );
}
...
function Details4() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start justify-center leading-[0] relative shrink-0 text-nowrap" data-name="Details">
      <div className="flex flex-col font-['Outfit:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#0c0d10] text-[14px]">
        <p className="leading-[18px] text-nowrap" dir="auto">
          Apple Inc.
        </p>
      </div>
      <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[#515254] text-[10px]">
...
function Amazon() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Amazon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Amazon">
          <path clipRule="evenodd" d={svgPaths.p218f4280} fill="var(--fill-0, #0C0D10)" fillRule="evenodd" id="amazon-[#160]" />
        </g>
      </svg>
    </div>
  );
...
function Details5() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start justify-center leading-[0] not-italic relative shrink-0 text-nowrap" data-name="Details">
      <div className="flex flex-col font-['outfit:Medium',sans-serif] justify-center relative shrink-0 text-[#0c0d10] text-[14px]">
        <p className="leading-[18px] text-nowrap" dir="auto">
          Amazon
        </p>
      </div>
      <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center relative shrink-0 text-[#515254] text-[10px]">
        <p className="leading-[14px] text-nowrap" dir="auto">
          21 Sep, 15:27 PM
        </p>
      </div>
...
function Bank() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Bank">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Bank">
          <path d={svgPaths.p3b7db200} id="Vector" stroke="var(--stroke-0, #0C0D10)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Amount4() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0" data-name="Amount">
      <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0d6826] text-[14px] text-nowrap">
        <p className="leading-[18px]" dir="auto">
          +$150.00
        </p>
      </div>
...
function Items3() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" data-name="Items">
      <MenuItem />
      <div className="h-0 relative shrink-0 w-full" data-name="Line">
        <div className="absolute inset-[-0.5px_0_0_0]" style={{ "--stroke-0": "rgba(208, 208, 209, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 348 1">
            <line id="Line" stroke="var(--stroke-0, #D0D0D1)" strokeWidth="0.5" x2="348" y1="0.25" y2="0.25" />
          </svg>
        </div>
      </div>
      <MenuItem1 />
...
function Title5() {
  return (
    <div className="content-stretch flex items-center px-0 py-[4px] relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['outfit:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c0d10] text-[18px] text-nowrap">
...
function Amount6() {
  return (
    <div className="content-stretch flex font-['outfit:Regular',sans-serif] gap-[4px] items-center leading-[0] not-italic relative shrink-0 text-nowrap w-[160px]" data-name="Amount">
      <div className="flex flex-col justify-center relative shrink-0 text-[#515254] text-[10px]">
        <p className="leading-[14px] text-nowrap">Amount</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#0c0d10] text-[14px]">
...
function Button16() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[36px] relative rounded-[10px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
    ...
    <div className="relative shrink-0 w-full" data-name="Rate">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-center justify-center px-[16px] py-0 relative w-full">
          <Exchange />
          <p className="font-['outfit:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap">1 GBP = 0.38 Omani Rial</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="h-[114px] relative shrink-0 w-[265px]" data-name="Graph">
      <div className="absolute inset-[-0.88%_-2.4%_-0.88%_-0.37%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 273 116">
          <g id="Graph">
            <path d={svgPaths.p38ffec80} id="Vector" stroke="var(--stroke-0, #0D6826)" strokeWidth="2" />
            <g id="Group">
              <path d={svgPaths.p25c75d00} fill="var(--fill-0, #0D6826)" id="Vector_2" stroke="var(--stroke-0, #0D6826)" strokeOpacity="0.1" strokeWidth="8" />
              <path d={svgPaths.p25c75d00} id="Vector_3" stroke="var(--stroke-0, #F6F7F9)" strokeWidth="1.1215" />
            </g>
          </g>
        </svg>
      </div>
...
function Number1() {
  return (
    <div className="content-stretch flex flex-col font-['outfit:Regular',sans-serif] gap-[24px] h-full items-start justify-center leading-[14px] not-italic relative shrink-0 text-[#515254] text-[10px] text-nowrap text-right" data-name="Number">
...
function Footer3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Footer">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['outfit:Regular',sans-serif] items-center justify-between leading-[14px] not-italic pb-0 pt-[4px] px-[18px] relative text-[#515254] text-[10px] text-nowrap w-full">
  ...
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[26px] relative rounded-[10px] shrink-0" data-name="Button">
      <div className="content-stretch flex h-full items-center justify-center overflow-clip px-[10px] py-[4px] relative rounded-[inherit]">
        <p className="font-['outfit:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap">48H</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Button19() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[26px] relative rounded-[10px] shrink-0" data-name="Button">
      <div className="content-stretch flex h-full items-center justify-center overflow-clip px-[10px] py-[4px] relative rounded-[inherit]">
        <p className="font-['outfit:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap">1W</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Button21() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(246,247,249,0.5)] h-[26px] relative rounded-[10px] shrink-0" data-name="Button">
      <div className="content-stretch flex h-full items-center justify-center overflow-clip px-[10px] py-[4px] relative rounded-[inherit]">
        <p className="font-['outfit:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#515254] text-[14px] text-nowrap">12M</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Graph3() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(208,208,209,0.3)] content-stretch flex flex-col h-[400px] items-start justify-between px-0 py-[16px] relative rounded-[12px] shrink-0 w-[348px]" data-name="Graph">
      <div aria-hidden="true" className="absolute border-[#d0d0d1] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Rate />
      <Graph2 />
      <Duration />
...
function Sidebar2() {
  return (
    <div className="bg-[#f6f7f9] h-full relative rounded-[28px] shrink-0 w-[380px]" data-name="Sidebar">
...
function Main2() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[#e7e7e8] grow h-full min-h-px min-w-px relative rounded-[36px] shrink-0" data-name="Main">
      <div className="overflow-clip rounded-[inherit] size-full">
      ...
      <div aria-hidden="true" className="absolute border-[#f6f7f9] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[36px]" />
    </div>
  );
}
...
function Section() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter basis-0 bg-[#f6f7f9] grow h-full min-h-px min-w-px relative rounded-[32px] shrink-0" data-name="Section">
      <div aria-hidden="true" className="absolute border-[#f6f7f9] border-[0.75px] border-solid inset-0 pointer-events-none rounded-[32px]" />
      <div className="size-full">
...
export default function DashboardLight() {
  return (
    <div className="bg-gradient-to-t from-[#c5c5c6] relative size-full to-[#aeaeaf]" data-name="Dashboard-Light">
      <div className="size-full">
