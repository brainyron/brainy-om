...
export function ExStories({ index }: { index: number }) {
  ...
  return (
    ...
    >
      <StoryShowcase
        title=""
        // Reordered: previously last (product story set) leads, the mid
        // stories sit in between, and the animated/moment pair anchors the
        // tail. story-8 and story-9 slot in between animated and moment so
        // the rail has more stops before the final frame.
        images={[
          ...
          { src: "/catey/stories/story-8.jpg", label: isAr ? "ستوري قطة" : "Cat moment" },
          { src: "/catey/stories/story-9.jpg", label: isAr ? "ستوري بومو" : "Pumo close-up" },
